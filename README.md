## Open Source Ethereum / Ethereum Classic / Ubiq - Mining Pool PPLNS / SOLO
...
Clone & compile:
    ...
    git clone https://github.com/MiningCryptoLive/open-etc-pool-friends-modified
    cd open-etc-pool-friends-modified
    cd build
    chmod 755 env.sh
    cd ..
    make
